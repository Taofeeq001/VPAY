...
const AboutHero = () => {
  return (
    <div className='bg-[url(/Images/Herocircle.svg)] bg-no-repeat bg-center mb-[1rem]'>
        <div className='container flex flex-col gap-2 lg:gap-5 items-center py-[5vh] lg:py-[10vh]'>
            <h1 className='text capitalize text-xl lg:text-5xl w-full lg:w-[55%] leading-[30px] text-center'>We are taking financial services to those at the remotest part of Africa.</h1>
            <p className='text text-[gray] font-bold w-full lg:w-[20%] text-center'>The World Bank reports that roughly 1.7 billion humans are unbanked, with 66% of adult population in Africa</p>
        </div>
