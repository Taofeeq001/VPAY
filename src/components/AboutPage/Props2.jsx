...
const Props2 = (props) => {
  return (
    <div className='bg-white px-4 lg:px-[5rem] py-[50px]'>
      <div className='container flex lg:flex-row flex-col w-full justify-between lg:gap-[29rem] items-center'>
        ...
        <Image width={500} height={500} className='w-full lg:w-[50%]' src={props.Image} />
      </div>
    </div>
  )
}
