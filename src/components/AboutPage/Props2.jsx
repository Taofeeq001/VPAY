      ...
      <div className='container flex lg:flex-row flex-col w-full justify-between lg:gap-[20rem] items-center'>
        <div className='w-full lg:w-[45%] flex flex-col gap-3'>
          ...
          <div className='flex flex-col gap-3'>
            <h3 className='capitalize text text-xl lg:text-4xl w-full lg:w-[85%]'>{props.heading}</h3>
            <p className='w-full lg:w-[100%]'>{props.paragraph}</p>
          </div>
        </div>
        <Image width={500} height={500} className='w-full lg:w-[556.59px]' src={props.Image} />
      </div>
    </div>
  )
}
